  ...
  return (
    <div>
      ...
      
      {
        ...
        ? <Link href={"/profiles/" + router.query.profileName} className="inline-block">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="size-8 ml-2 mt-2 text-gray-500">
